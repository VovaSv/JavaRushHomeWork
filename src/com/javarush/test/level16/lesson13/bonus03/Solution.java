...
public class Solution {
    ...
    public static class TestedThread extends Thread {
        public TestedThread(UncaughtExceptionHandler handler) {
            ...
            //Change from setUncaughtExceptionHandler to setDefaultUncaughtExceptionHandler
            //Because setDefault set for all threads ans setUncaught only for specific thread.
